...
namespace Mocking
{
    ...
    public class MockTests
    {
        ...
        public void CanCalculateWeeklySalaryOfSingleEmployee()
        {
            ...
            mock.Setup(m => m.LoadEmployee(ID)).Returns(() => 
                new Employee() { Id = ID, Name = "Hans", Type = "Teacher", Wage = 1000 });
        ...
        public void CanCalculateTotalWeeklySalaryOfAllEmployees()
        {
            ...
            var mock = new Mock<IEmployeeRepository>();
            mock.Setup(m => m.FindAllEmployees()).Returns(() => 
                new List<Employee> { new Employee() { Id = 1, Name = "Hans", Type = "Teacher", Wage = 1000 },
        ...
        public void AfterMailSentMessageCanBeFoundInEmployeesNumReceivedMessages()
        {
            ...
            mock.Setup(m => m.LoadEmployee(ID))
                .Returns(() => new Employee() { Id = ID, Name = "Hans", Type = "Teacher", Wage = 1000,
                    MailBox = new MailBox() { NumReceivedMessages = 0 } });
